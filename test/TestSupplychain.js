...
contract("SupplyChain", function (accounts) {
  ...
  it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
    ...
    assert.equal(
      resultBufferTwo[6],
      distributorID,
      "Error: Invalid item Distributor"
    );
    assert.equal(eventEmitted, true, "Invalid event emitted");
  });
  ...
  it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async () => {
    ...
    assert.equal(
      resultBufferOne[3],
      originFarmerID,
      "Error: Invalid item Farm ID"
    );
    assert.equal(
      resultBufferOne[4],
      originFarmName,
      "Error: Invalid item Farm Name"
    );
    assert.equal(
      resultBufferOne[5],
      originFarmInformation,
      "Error: Invalid item Farm Information"
    );
    assert.equal(
      resultBufferOne[6],
      originFarmLatitude,
      "Error: Invalid item Farm Latitude"
    );
    assert.equal(
      resultBufferOne[7],
      originFarmLongitude,
